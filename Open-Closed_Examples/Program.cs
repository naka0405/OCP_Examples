...
namespace Open_Closed_Examples
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var engineer = new Astronaut(new Person("NK", 38), new Engineer());
            var aircraftMechanic = new Astronaut(new Person("James Arnb", 35), new AircraftMechanic());
            var astromomer = new Astronaut(new Person("Ana Ree", 36), new Astronomer(astronomManager));
